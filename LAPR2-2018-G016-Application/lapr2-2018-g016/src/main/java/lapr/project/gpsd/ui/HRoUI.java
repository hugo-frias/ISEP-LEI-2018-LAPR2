 ...
 */
public class HRoUI implements Initializable {

    @FXML
    private Button btnRegistSP;
    @FXML
    private Button btnEvaluateSP;
    ...
    @FXML
    private void registServiceProvider(ActionEvent event) throws IOException {
        changeScene("/fxml/RegisterServiceProvider.fxml");
    }

    @FXML
    private void evaluateServiceProvider(ActionEvent event) throws IOException {
        changeScene("/fxml/EvaluateServiceProvider.fxml");
    }
